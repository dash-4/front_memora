...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (errorData && typeof errorData === "object") {
        ...
        toast.error("Ошибка сервера. Проверьте логи Django", {
          id: "register-error",
        });
      } else {
  ...
  return (
    ...
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-purple-100 via-slate-50 to-blue-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <Link to="/" className="inline-block group">
            <div className="relative inline-flex items-center justify-center w-16 h-16 bg-blue-600 rounded-2xl mb-4 shadow-2xl shadow-blue-200 group-hover:scale-110 transition-transform duration-300">
              <Brain className="text-white" size={32} />
            </div>
          </Link>
          ...
          <p className="text-gray-500 mt-2 font-medium">
            Начните свой путь к идеальной памяти
          </p>
        </div>

        <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] p-8 border border-white/20">
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Логин"
                    className={`w-full pl-11 pr-4 py-3 bg-gray-50/50 border-2 rounded-xl focus:ring-4 focus:ring-blue-500/5 focus:bg-white outline-none transition-all ${
                      errors.username
                        ? "border-red-200"
            ...
            <Button
              type="submit"
              className="w-full py-4 mt-4 bg-gray-900 hover:bg-black text-white rounded-2xl shadow-xl shadow-gray-200 transform active:scale-[0.98] transition-all"
              disabled={loading}
            >
              {loading ? (
